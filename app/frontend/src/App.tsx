...
export default function App() {
  ...
  if (isCheckingAuth) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 app-shell">
  ...
  return (
    <div className="min-h-screen bg-gray-50 app-shell">
      {/* Navigation */}
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-50 app-nav">
